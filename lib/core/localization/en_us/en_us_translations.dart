...
final Map<String, String> enUs = {
  // 1 - Onboarding Screen
  "msg_diverse_sparkling": "Diverse & sparkling food.",
  "msg_we_use_the_best":
      "We use the best local ingredients to create fresh and delicious food and drinks.",

  // 2 - Onboarding Screen
  "msg_free_shipping_on": "Free shipping on all orders",
  ...
  "lbl_or": "OR",
  "msg_connect_with_facebook": "Connect with Facebook",
  "msg_connect_with_google": "Connect with Google",

  // Signup Strings
  "msg_hello_create_account": "Hello! Create Account",
