...
part of 'popular_product_state.dart';
...
/// @nodoc
abstract class $PopularProductStateCopyWith<T, $Res> {
  factory $PopularProductStateCopyWith(PopularProductState<T> value,
          $Res Function(PopularProductState<T>) then) =
      _$PopularProductStateCopyWithImpl<T, $Res, PopularProductState<T>>;
}

/// @nodoc
class _$PopularProductStateCopyWithImpl<T, $Res,
        $Val extends PopularProductState<T>>
    implements $PopularProductStateCopyWith<T, $Res> {
  _$PopularProductStateCopyWithImpl(this._value, this._then);
...
class __$$IdleCopyWithImpl<T, $Res>
    extends _$PopularProductStateCopyWithImpl<T, $Res, _$Idle<T>>
...
class _$Idle<T> implements Idle<T> {
  ...
  @override
  String toString() {
    return 'PopularProductState<$T>.idle()';
  }
...
abstract class Idle<T> implements PopularProductState<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$PopularProductStateCopyWithImpl<T, $Res, _$Loading<T>>
...
class _$Loading<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'PopularProductState<$T>.loading()';
  }
...
abstract class Loading<T> implements PopularProductState<T> {
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$PopularProductStateCopyWithImpl<T, $Res, _$Success<T>>
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'PopularProductState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements PopularProductState<T> {
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$PopularProductStateCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'PopularProductState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements PopularProductState<T> {
