...
/// @nodoc
abstract class $SetMenuStateCopyWith<T, $Res> {
  factory $SetMenuStateCopyWith(
          SetMenuState<T> value, $Res Function(SetMenuState<T>) then) =
      _$SetMenuStateCopyWithImpl<T, $Res, SetMenuState<T>>;
}

/// @nodoc
class _$SetMenuStateCopyWithImpl<T, $Res, $Val extends SetMenuState<T>>
    implements $SetMenuStateCopyWith<T, $Res> {
  _$SetMenuStateCopyWithImpl(this._value, this._then);
...
class __$$IdleCopyWithImpl<T, $Res>
    extends _$SetMenuStateCopyWithImpl<T, $Res, _$Idle<T>>
...
abstract class Idle<T> implements SetMenuState<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$SetMenuStateCopyWithImpl<T, $Res, _$Loading<T>>
...
abstract class Loading<T> implements SetMenuState<T> {
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$SetMenuStateCopyWithImpl<T, $Res, _$Success<T>>
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'SetMenuState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements SetMenuState<T> {
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$SetMenuStateCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'SetMenuState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements SetMenuState<T> {
