...
part of 'popular_product_get_state.dart';
...
/// @nodoc
mixin _$PopularProductGetState<T> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $PopularProductGetStateCopyWith<T, $Res> {
  factory $PopularProductGetStateCopyWith(PopularProductGetState<T> value,
          $Res Function(PopularProductGetState<T>) then) =
      _$PopularProductGetStateCopyWithImpl<T, $Res, PopularProductGetState<T>>;
}

/// @nodoc
class _$PopularProductGetStateCopyWithImpl<T, $Res,
        $Val extends PopularProductGetState<T>>
    implements $PopularProductGetStateCopyWith<T, $Res> {
  _$PopularProductGetStateCopyWithImpl(this._value, this._then);
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$PopularProductGetStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
class _$IdleImpl<T> implements Idle<T> {
  ...
  @override
  String toString() {
    return 'PopularProductGetState<$T>.idle()';
  }
...
abstract class Idle<T> implements PopularProductGetState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$PopularProductGetStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'PopularProductGetState<$T>.loading()';
  }
...
abstract class Loading<T> implements PopularProductGetState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$PopularProductGetStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'PopularProductGetState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements PopularProductGetState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$PopularProductGetStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'PopularProductGetState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements PopularProductGetState<T> {
